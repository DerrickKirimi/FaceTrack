...
fface1_haar_path = '/usr/local/share/opencv4/haarcascades/haarcascade_frontalface_default.xml'
# frontal face pattern detection
fface2_haar_path = '/usr/local/share/opencv4/haarcascades/haarcascade_frontalface_alt2.xml'
# side face pattern detection
pface1_haar_path = '/usr/local/share/opencv4/haarcascades/haarcascade_profileface.xml'
